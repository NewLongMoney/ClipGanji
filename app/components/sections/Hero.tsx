    ...
    return (
        <section className="relative min-h-screen flex items-center justify-center pt-24 pb-12 overflow-hidden">
            ...
            <div className="container mx-auto px-6 max-w-7xl relative z-10 flex flex-col items-center text-center">
                ...
                <motion.div
                    className="mb-8 font-anton text-4xl md:text-5xl tracking-widest animate-brand-hover cursor-default"
                    variants={itemVariants}
                    initial="hidden"
                    animate="show"
                >
                    <span className="text-white">CLIP</span>
                    <span className="text-green transition-colors duration-300">GANJI</span>
                </motion.div>
